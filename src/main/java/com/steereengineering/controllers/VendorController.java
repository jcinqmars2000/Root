...
public class VendorController {
	...
	public VendorController(EmployeeService employeeService, VendorService vendorService) {
	...
	public String getIndexPageAtRoot(Model model) {
		...
		Vendor vendor = vendorService.findById(Long.valueOf(1));
		System.out.println("license count = " + vendor.getLicenses().size());
	...
	public String showById(@PathVariable String id, Model model){
		...
		Vendor vendor = vendorService.findById(Long.valueOf(id));
		Set<License> licenses = vendor.getLicenses();
